      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-6 max-w-[1600px] mx-auto">
        ...
        <div className="md:col-span-2">
          ...
          <ul className="flex flex-col gap-2">
            <li>
              <Link href="/terminos"className="link-draw font-mono text-[11px] uppercase tracking-[0.18em] text-[color:var(--color-grey-300)]">
                Términos
              </Link>
            </li>
            <li>
              <Link href="/privacidad"className="link-draw font-mono text-[11px] uppercase tracking-[0.18em] text-[color:var(--color-grey-300)]">
                Privacidad
              </Link>
            </li>
            <li>
              <Link href="/admin"className="link-draw font-mono text-[11px] uppercase tracking-[0.18em] text-[color:var(--color-grey-700)]">
                Admin
              </Link>
            </li>
          </ul>
